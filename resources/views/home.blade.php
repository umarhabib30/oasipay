        ...
        <section class="buy-follow-receive">
            ...
            <div class="right-box">
                ...
                <i class="fas fa-link"></i>
                        ...
                        <!-- Show code  -->
                        <input type="text" placeholder="Transaction Code" id="transaction_code">
                        <!-- Right Arrow -->
                        <div class="arrow-right">
                            <i class="fas fa-chevron-right" id="get_tracking"></i>
                        </div>
                    </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            $('body').on('click', '#get_tracking', function(e) {
                let code = $('#transaction_code').val();
                ...
                let url = "{{ route('monitoring.transactions', ':code') }}".replace(':code', code);
