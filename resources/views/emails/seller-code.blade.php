                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="font-family: arial,helvetica,sans-serif; font-size: 14px; color: #b3b3b3; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;">Subject <strong style=" color: black; margin-left: 25px;">Your Seller Code</strong></p>
                              </div>
                  ...
                  <div style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    ...
                    <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                      ...
                      <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px;font-family:'Cabin',sans-serif;" align="left">

                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%; margin: 0px;"><span style="color: #000000; white-space: normal; background-color: #ffffff; margin-top: 10px; line-height: 19.6px;">
                                        Here are the details of your transaction. If you click on the "Transaction code" you will be automatically redirected on monitoring page
                                    </span>
                                </p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;display:flex;">
                                ...
                                <p style="line-height: 140%; margin: 0px; width: 49%;text-align: center;color: #bdbdbd;"><a href="{{ url('receive-payment-for',$data['seller_code']) }}" style="color: rgb(55, 169, 218); text-decoration: none; line-height: inherit;">   Receive a payment </a></p>
                              </div>
                              ...
                              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tbody><tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="https://assets.unlayer.com/projects/271871/1744296460532-seller_code_email.jpg?w=360px" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 180px;" width="180">
